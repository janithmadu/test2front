...
const EditHeadOfficeForBusinessUnit = () => {
                ...
                <Formik
                    ...
                    onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                        ...
                        await editOneBusinessForUnit(params.id, {
                            ...
                            type: values.type,
                            headOffice: true,
                            headOfficeId: params.id,
                            businessId: params.id
                        });
                        navigate(`../head-Office/${businessId}`, true);
                    }}
                        ...
                        <form noValidate onSubmit={handleSubmit}>
                            ...
                            <Permission name="businessEdit" type="button">
                                <Box sx={{ textAlign: 'right', marginTop: '10px' }}>
                                    <Link to={`../head-Office/${businessId}`}>
...
export default EditHeadOfficeForBusinessUnit;
