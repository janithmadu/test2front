...
const EditDocumentMainCategory = () => {
    ...
    const PostMainCategory = async () => {
        ...
        navigate(`/documents/sub/${params.id}`, true);
    };
        ...
        <Permission name="documentsCategoryAdd">
            <FormBox>
                <Typography variant="h3" sx={{ textAlign: 'center', marginBottom: '20px' }}>
                     Document Main Category Details
                </Typography>
                                    ...
                                    <Box sx={{ textAlign: 'right', marginTop: '10px' }}>
                                        <Link to={`/documents/sub/${params.id}`}>
...
export default EditDocumentMainCategory;
