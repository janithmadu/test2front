...
import { getOneItem, editItem, getAllItemCategoryProducts,deleteItem } from '../../services/api';
...
const OneProduct = () => {
    ...
    const inputDisable = usePermission('productsEdit');
            ...
            <FormBox>
                ...
                >
                    {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
                        ...
                        <Permission name="productsEdit" type="button">
                                    <Link to={`../products`}>
                            ...
                            <Permission name="productsDelete" type="button">
